...
Что бы полностью реализовать [[С++. Что такое The Rule of Zero, Three, Five|С++. Что такое The Rule of Zero, Three, Five]] нам нужно еще добавить определение для _Оператора Присваивания_.
...
Предположим, что мы закончили, [[С++. Что такое The Rule of Zero, Three, Five|С++. Что такое The Rule of Zero, Three, Five]] соблюдено, но теперь наш код страдает от трех проблем:
