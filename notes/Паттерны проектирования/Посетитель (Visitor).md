...
Мы добавили двухслойное косвенное обращение к нужному нам функционалу. И таким образом мы перестали нарушать принцип “Единственной ответственности”, и принцип “Открытия/Закрытия”. Данный хак называется: [[C++. Что такое двойная диспетчеризация|C++. Что такое двойная диспетчеризация]].
