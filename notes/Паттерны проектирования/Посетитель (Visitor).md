...
2. [[Посетитель (Visitor)]][[Overview information]][[Overview information]]
    1. [[Посетитель (Visitor)]]
...
Мы добавили двухслойное косвенное обращение к нужному нам функционалу. И таким образом мы перестали нарушать принцип “Единственной ответственности”, и принцип “Открытия/Закрытия”. Данный хак называется: [[notes/interview-questions-shared/questions/C++. Что такое двойная диспетчеризация|C++. Что такое двойная диспетчеризация]].
