...
Что бы полностью реализовать [[notes/Вопросы задаваемые на собеседованиях/С++. Что такое The Rule of Three]] нам нужно еще добавить определение для _Оператора Присваивания_.
...
Предположим, что мы закончили, [[notes/Вопросы задаваемые на собеседованиях/С++. Что такое The Rule of Three]] соблюдено, но теперь наш код страдает от трех проблем:
...
Вот [[notes/Вопросы задаваемые на собеседованиях/C++. Почему в copy-and-swap идиоме, swap - это friend функция]]на объяснение, почему же $swap$﻿ это $friend$﻿-функция.
