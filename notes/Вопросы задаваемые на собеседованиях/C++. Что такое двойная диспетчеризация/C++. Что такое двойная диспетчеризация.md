...
Метод неплохой, но тут мы неявно переписываем [[notes/interview-questions-shared/questions/С++. Что такое виртуальная таблица методов]], которую итак создает компилятор.
