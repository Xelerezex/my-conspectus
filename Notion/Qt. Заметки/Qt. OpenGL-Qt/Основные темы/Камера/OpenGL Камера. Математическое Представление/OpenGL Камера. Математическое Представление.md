...
$\overrightarrow{\textcolor{\#0000FF}{f}}$
...
$\overrightarrow{\textcolor{\#FF0000}{left}} $

А значит в нормализованном виде, это будет выглядеть как:

$\overrightarrow{\textcolor{\#FF0000}{l}} $

И наконец-то в-третьих, мы высчитываем номализованный $\overrightarrow{\textcolor{\#01FF00}{верхний}}$﻿ вектор, при помощи всех прошлых вычислений. Мы так же берем векторное выражение $\overrightarrow{\textcolor{\#FF0000}{левого}}$﻿ и $\overrightarrow{\textcolor{\#0000FF}{переднего}}$﻿, а значит все эти три вектора ортонормальны. Обратим внимание, что мы не высчитываем в ручную нормализацию вектора $\overrightarrow{\textcolor{#01FF00}{u}}$﻿, так как векторное произведение двух единичных векторов как раз и дает единичный вектор:

$\overrightarrow{\textcolor{\#01FF00}{u}} $

Эти три базовых вектора $\overrightarrow{\textcolor{\#01FF00}{u}}, $﻿ как раз-таки и нужны для конструирования матрицы поворота $M_{R}$﻿. Однако мы не должны забывать, про то, что матрица должна быть инвертирована.  
Предположим, что  
